...
<html lang="es">
  <head>
    ...
    <title>Catálogo Usuarios | PROCYON</title>
...
<hr>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" style="background-color:#eaeef4; height:100%;">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 mb-3 ">
        <h1 class="display-4">Catálogo Usuarios</h1>
    ...
    <form name="formulario1" method="post" action="catalogo_usuarios.php" id="formulario1" class="form-search">
...
?>
        ...
        <thead class="text-center">
            <tr>
                ...
                <th scope="col">Tipo de privilegio</th>
        ...
        <?php
            ...
            while($row = $resultadotabla->fetch_assoc()){
                ...
                // echo '<tr>';
                    ...
                    echo   ' <h5 class="modal-title" id="exampleModalLabel">Contraseña asignada</h5>';
