...
<html lang="es">
  <head>
    ...
    <title>Modificar Usuario | PROCYON</title>
          ...
          <hr class="my-4">
            <input type="hidden" name="id" value="<?php echo $row['id']?>">
              ...
              <div class="input-group mb-3 w-50">
                ...
                <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="usr" value="<?php echo $row['usr']?>" require>
              </div>
              ...
              <div class="input-group mb-3 w-50">
                ...
                <input type="password" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="pwd" value="<?php echo $row['pwd']?>" require>
              </div>
              ...
              <div class="input-group mb-3 w-50">
                ...
                <select class="custom-select" id="inputGroupSelect01" name="priv" require>
                  <option selected value="<?php echo $row['priv']?>">
